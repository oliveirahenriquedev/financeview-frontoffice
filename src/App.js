    ...
    <div>
      <div className="relative min-h-screen flex flex-col md:flex-row justify-center align-center p-4 bg-black">
        ...
        <Card className="relative z-10 p-6 bg-white shadow-md rounded-lg w-full md:w-1/2 lg:w-1/3 xl:h-[380px] lg:h-[400px] sm:h-[350px] md:min-h-[500px] flex flex-col md:mb-0 md:ml-24 lg:mt-64 md:mt-64 mr-20">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center animate-fade-in mb-4 font-roboto">
            Boas-vindas ao <span className="text-yellow-500">FinanceView</span>
          </h1>
          <p className="flex justify-center text-sm sm:text-base md:text-lg lg:text-xl text-center animate-fade-in mb-4 font-roboto w-full">
          ...
          <button
            ...
            className="bg-green-100 text-black font-semibold border-dotted rounded shadow hover:bg-green-300 animate-fade-in delay-150 duration-100 transform hover:scale-105 transition ease-linear px-4 py-2 mb-4 animate-fade-in font-roboto"
          >
            Ir para os gráficos
          </button>
          <div
          ...
          >
            <button onClick={() => navigate(user ? "/account" : "/signup")}>
              <p className="mr-2 text-teal-700 animate-fade-in font-roboto">
