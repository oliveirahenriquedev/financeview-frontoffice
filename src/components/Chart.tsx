      ...
      {displayButton ? (
        <div className="flex mt-auto mb-auto flex-col justify-center">
          <button
            ...
            type="button"
            className={`text-white bg-gradient-to-r from-indigo-400 via-indigo-500 to-indigo-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:focus:ring-indigo-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 animate-fade-in mr-auto ml-auto`}
