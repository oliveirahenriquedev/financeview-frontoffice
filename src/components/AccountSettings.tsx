...
import { getUserImage, putUserInfo } from "../api.ts";
...
export function AccountSettings() {
  ...
  if (!user) {
    return (
      <Box
        className="bg-gradient-to-b from-white to-black h-screen w-screen flex flex-col justify-center items-center font-inter"
        sx={{
          padding: 2,
        }}
      >
        ...
        >
          <Box className="flex flex-col justify-center items-center font-inter">
